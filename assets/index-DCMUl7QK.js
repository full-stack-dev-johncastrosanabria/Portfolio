...
Buenas integraciones nacen de buenos contratos. Cuando la API y el frontend se entienden bien, el producto se siente más rápido, confiable y profesional.
    `,tags:[`API Design`,`UX`,`Frontend`,`Backend`],publishedAt:`2026-04-22`,readingTime:`5 min`,source:`local`}];function K(e,t=`local`){if(`data`in e){let n=e.data();return{id:e.id,slug:n.slug??e.id,title:n.title??``,excerpt:n.excerpt??``,content:n.content??``,tags:n.tags??[],publishedAt:n.publishedAt??new Date().toISOString(),readingTime:n.readingTime??`4 min`,source:t}}return{...e,source:t}}function q(){let[e,t]=(0,S.useState)(we.map(e=>K(e))),[n,r]=(0,S.useState)(U),[i,a]=(0,S.useState)(``);return(0,S.useEffect)(()=>{async function e(){if(!U||!G){r(!1);return}try{let e=await _(p(x(G,`posts`),h(`publishedAt`,`desc`)));e.empty||t(e.docs.map(e=>K(e,`firebase`)))}catch(e){console.warn(`No se pudieron cargar los posts desde Firebase. Se usarán los locales.`,e),a(`blog.firebaseFallback`)}finally{r(!1)}}e()},[]),{posts:(0,S.useMemo)(()=>[...e].sort((e,t)=>new Date(t.publishedAt).getTime()-new Date(e.publishedAt).getTime()),[e]),isLoading:n,error:i}}var Te={en:{1:{title:`.NET 10: New features and performance improvements`,excerpt:`.NET 10 brings meaningful improvements in performance, security and developer tooling. These are the key features worth knowing.`,content:`
