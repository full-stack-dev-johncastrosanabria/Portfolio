import{n as e}from"./rolldown-runtime-DF2fYuay.js";import{a as t,c as n,d as r,f as i,i as a,l as o,n as s,o as c,r as l,s as u,t as d,u as f}from"./react-vendor-DJDjReJf.js";import{a as p,c as m,i as h,l as g,n as _,o as v,r as y,s as b,t as x}from"./vendor-HNjA9ERI.js";(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin===`use-credentials`?t.credentials=`include`:e.crossOrigin===`anonymous`?t.credentials=`omit`:t.credentials=`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();var S=e(i(),1),C=e(r(),1),w=l();function T(){return(0,w.jsxs)(`div`,{className:`animated-background`,"aria-hidden":`true`,children:[(0,w.jsx)(`div`,{className:`liquid-field liquid-field-primary`}),(0,w.jsx)(`div`,{className:`liquid-field liquid-field-secondary`}),(0,w.jsx)(`div`,{className:`liquid-mesh`})]})}var E={author:`John Castro Sanabria`,role:`Ingeniero de software full-stack | .NET, Java, Spring Boot, React, TypeScript y SQL | Azure DevOps | Certificado AZ-900 y MS-900`,roleLocalized:{es:`Ingeniero de software full-stack | .NET, Java, Spring Boot, React, TypeScript y SQL | Azure DevOps | Certificado AZ-900 y MS-900`,en:`Full-stack software engineer | .NET, Java, Spring Boot, React, TypeScript and SQL | Azure DevOps | AZ-900 and MS-900 certified`},email:`castrosanabriajohn@gmail.com`,headline:`Ingeniero de software full-stack especializado en .NET, Java, Spring Boot, React, TypeScript, SQL y arquitectura limpia. Construyo soluciones escalables y mantenibles.`,headlineLocalized:{es:`Ingeniero de software full-stack especializado en .NET, Java, Spring Boot, React, TypeScript, SQL y arquitectura limpia. Construyo soluciones escalables y mantenibles.`,en:`Full-stack software engineer specialized in .NET, Java, Spring Boot, React, TypeScript, SQL and clean architecture. I build scalable and maintainable solutions.`},description:`Portafolio profesional de John Castro Sanabria. Ingeniero de software full-stack con experiencia en .NET, Java, Spring Boot, React, TypeScript, SQL, Azure DevOps y arquitectura limpia. Certificado AZ-900 y MS-900.`,descriptionLocalized:{es:`Portafolio profesional de John Castro Sanabria. Ingeniero de software full-stack con experiencia en .NET, Java, Spring Boot, React, TypeScript, SQL, Azure DevOps y arquitectura limpia. Certificado AZ-900 y MS-900.`,en:`Professional portfolio of John Castro Sanabria. Full-stack software engineer with experience in .NET, Java, Spring Boot, React, TypeScript, SQL, Azure DevOps and clean architecture. AZ-900 and MS-900 certified.`},ctaPrimary:`Ver proyectos`,ctaPrimaryLocalized:{es:`Proyectos`,en:`View projects`},ctaSecondary:`Leer blog técnico`,ctaSecondaryLocalized:{es:`Blog técnico`,en:`Technical blog`},ctaYouTubeLocalized:{es:`YouTube`,en:`YouTube`},ctaGitHubLocalized:{es:`GitHub`,en:`GitHub`},resumeDownloads:{es:`resume/John_Castro_Sanabria_CV_ES.pdf`,en:`resume/John_Castro_Sanabria_CV_EN.pdf`},youtubeUrl:`https://www.youtube.com/@JohnCastroTechLabs`,githubProfileUrl:`https://github.com/full-stack-dev-johncastrosanabria/`,socialLinks:[{label:{es:`Correo`,en:`Email`},href:`mailto:castrosanabriajohn@gmail.com`,icon:`mail`},{label:`GitHub`,href:`https://github.com/full-stack-dev-johncastrosanabria`,icon:`github`},{label:`LinkedIn`,href:`https://www.linkedin.com/in/john-castro-sanabria/`,icon:`linkedin`}],keywords:[`.NET`,`Java`,`Spring Boot`,`React`,`Full Stack`,`TypeScript`,`Clean Architecture`,`API REST`,`SQL Server`,`Azure`,`Azure DevOps`,`AZ-900`,`MS-900`,`JavaScript`,`C#`,`Web Development`]},D=(0,S.createContext)(null);function ee(){let e=(0,S.useContext)(D);if(!e)throw Error(`useTheme must be used within ThemeProvider`);return e}var O=e=>`/Portfolio/${e.replace(/^\//,``)}`;function k(e,t=`es`){return!e||typeof e!=`object`||Array.isArray(e)?e:e[t===`en`?`en`:`es`]??e.es??e.en??``}function te(){let{t:e,i18n:t}=d(),{theme:n,toggleTheme:r}=ee(),i=t.resolvedLanguage||t.language,a=[{to:`/`,label:e(`nav.home`)},{to:`/blog`,label:e(`nav.blog`)}];function o(){let e=i===`es`?`en`:`es`;t.changeLanguage(e),localStorage.setItem(`portfolio-language`,e),document.documentElement.lang=e}return(0,w.jsx)(`header`,{className:`site-header`,children:(0,w.jsxs)(`div`,{className:`container nav-wrapper`,children:[(0,w.jsxs)(c,{className:`brand`,to:`/`,viewTransition:!0,children:[(0,w.jsx)(`span`,{className:`brand-mark brand-avatar`,children:(0,w.jsx)(`img`,{src:O(`profile-john.png`),alt:`Foto de John Castro`})}),(0,w.jsxs)(`span`,{children:[(0,w.jsx)(`strong`,{children:E.author}),(0,w.jsx)(`span`,{className:`brand-subtitle`,children:k(E.roleLocalized,i)})]})]}),(0,w.jsxs)(`nav`,{className:`nav-links`,"aria-label":`Principal`,children:[a.map(e=>(0,w.jsx)(c,{to:e.to,viewTransition:!0,className:({isActive:e})=>e?`nav-link nav-link-active`:`nav-link`,children:e.label},e.to)),(0,w.jsx)(`button`,{className:`language-toggle`,type:`button`,onClick:o,"aria-label":e(`nav.language`),title:e(`nav.language`),children:i===`es`?`EN`:`ES`}),(0,w.jsx)(`button`,{className:`icon-toggle`,type:`button`,onClick:r,"aria-label":e(`nav.theme`),title:e(`nav.theme`),children:(0,w.jsx)(`span`,{"aria-hidden":`true`,children:n===`dark`?`☀`:`☾`})})]})]})})}function ne(){let{i18n:e}=d(),t=e.resolvedLanguage||e.language;return(0,w.jsx)(`footer`,{className:`site-footer`,children:(0,w.jsxs)(`div`,{className:`container footer-grid`,children:[(0,w.jsxs)(`div`,{className:`footer-brand`,children:[(0,w.jsx)(`img`,{className:`footer-brand-mark`,src:O(`brand-mark.svg`),alt:`Logo personal de John Castro`}),(0,w.jsxs)(`div`,{children:[(0,w.jsx)(`p`,{className:`footer-title`,children:E.author}),(0,w.jsx)(`p`,{className:`footer-copy`,children:k(E.descriptionLocalized,t)})]})]}),(0,w.jsx)(`div`,{className:`footer-links`,children:E.socialLinks.map(e=>(0,w.jsx)(`a`,{href:e.href,target:`_blank`,rel:`noreferrer`,children:k(e.label,t)},e.href))})]})})}function re(){return(0,w.jsxs)(`div`,{className:`app-shell`,children:[(0,w.jsx)(`div`,{className:`scroll-progress`,"aria-hidden":`true`}),(0,w.jsx)(T,{}),(0,w.jsx)(te,{}),(0,w.jsx)(`main`,{className:`main-content`,children:(0,w.jsx)(u,{})}),(0,w.jsx)(ne,{})]})}var ie=[{id:`az-900`,title:{es:`Microsoft Certified: Azure Fundamentals`,en:`Microsoft Certified: Azure Fundamentals`},issuer:`Microsoft`,issuedAt:{es:`30 de enero de 2026`,en:`January 30, 2026`},category:{es:`Cloud fundamentals`,en:`Cloud fundamentals`},credentialId:`407DBE67BFC78ED5`,certificationNumber:`DBD678-318E1C`,status:{es:`Activa`,en:`Active`},image:`certifications/az-900.png`,featured:!0},{id:`ms-900`,title:{es:`Microsoft 365 Certified: Fundamentals`,en:`Microsoft 365 Certified: Fundamentals`},issuer:`Microsoft`,issuedAt:{es:`6 de julio de 2025`,en:`July 6, 2025`},category:{es:`Productividad y Microsoft 365`,en:`Productivity and Microsoft 365`},credentialId:`1C458F347531B23`,certificationNumber:`E2Y3C0-A961A5`,status:{es:`Activa`,en:`Active`},image:`certifications/ms-900.png`,featured:!0},{id:`commercial-skills`,title:{es:`Desarrollo de habilidades comerciales`,en:`Commercial skills development`},issuer:`RD Consultores & Asociados / Novacomp`,issuedAt:{es:`Enero de 2026`,en:`January 2026`},category:{es:`Preventa y ciclo de ventas`,en:`Pre-sales and sales cycle`},hours:`8 h`,image:`certifications/commercial-skills.svg`},{id:`data-science`,title:{es:`Programa de Data Science`,en:`Data Science program`},issuer:`Mundos E / Universidad Nacional de Córdoba`,issuedAt:{es:`11 de agosto de 2022`,en:`August 11, 2022`},category:{es:`Data Science`,en:`Data Science`},hours:`181 h`,image:`certifications/data-science.svg`}],A=[`novamp-sinpe`,`novatoken`,`novabank`,`nova-expediente-novacomp`,`business-ai-analytics`,`reactivities`,`portfolio`,`clean-api`,`basic-business-app`,`etickets`,`spring-demo`,`meals-to-go`,`expo-amplify-demo`,`admin-dashboard`,`propflow`,`vue-project`,`flask-product-api`,`personas-solution`,`webapi-matricula`,`wcf-tarjetas`,`smartgym-api`],ae=[...[{id:`novamp-sinpe`,title:{es:`NovaMP SINPE - Plataforma de Pagos Electrónicos`,en:`NovaMP SINPE - Electronic Payments Platform`},category:{es:`Proyecto profesional fintech`,en:`Professional fintech project`},description:{es:`Plataforma de medios de pago para entidades conectadas al Sistema Nacional de Pagos Electrónicos SINPE del Banco Central de Costa Rica.`,en:`Payments platform for institutions connected to Costa Rica Central Bank electronic payments network, SINPE.`},highlights:{es:[`Construí módulos de configuración y reportería financiera para operación de entidades certificadas por el BCCR.`,`Atendí hotfixes en producción, cuidando disponibilidad 24/7 para más de 10 entidades financieras.`,`Participé en funcionalidades relacionadas con movilización electrónica de fondos entre cuentas IBAN.`,`Trabajé sobre una solución SaaS con soporte operativo crítico y estándares de conexión BCCR-SINPE.`],en:[`Built configuration and financial reporting modules for institutions certified by the Central Bank of Costa Rica.`,`Handled production hotfixes while supporting 24/7 availability for more than 10 financial institutions.`,`Contributed to features related to electronic fund movement between IBAN accounts.`,`Worked on a SaaS solution with critical operational support and BCCR-SINPE connection standards.`]},technologies:[`C#`,`.NET`,`React`,`SQL Server`,`Fintech`,`BCCR-SINPE`],links:[{label:{es:`Ver sitio`,en:`View site`},href:`https://www.in-novative.com/novamp-sinpe/`,primary:!0}],featured:!0},{id:`novatoken`,title:{es:`NovaToken - Autenticación de Dos Factores (2FA)`,en:`NovaToken - Two-Factor Authentication (2FA)`},category:{es:`Proyecto profesional seguridad`,en:`Professional security project`},description:{es:`Solución SoftToken de segundo factor de autenticación para reforzar seguridad transaccional, OTP y cumplimiento regulatorio financiero.`,en:`SoftToken second-factor authentication solution for transactional security, OTP flows and financial regulatory compliance.`},highlights:{es:[`Desarrollé el BackOffice en React para operación y consulta de evidencias, usuarios y procesos de seguridad.`,`Mantuve lógica de tokens OTP con expiración de 60 segundos para canales transaccionales.`,`Trabajé en una solución orientada a cumplimiento con reguladores financieros en LATAM.`,`Colaboré en flujos de seguridad para robustecer autenticación y reducir riesgo de acceso no autorizado.`],en:[`Built the React BackOffice for operations and review of evidence, users and security processes.`,`Maintained OTP token logic with 60-second expiration for transactional channels.`,`Worked on a solution oriented to compliance with financial regulators in LATAM.`,`Contributed to security flows that strengthen authentication and reduce unauthorized access risk.`]},technologies:[`C#`,`.NET`,`React`,`SQL Server`,`2FA`,`OTP`,`Security`],links:[{label:{es:`Ver sitio`,en:`View site`},href:`https://www.in-novative.com/nova-token/`,primary:!0}],featured:!0},{id:`novabank`,title:{es:`NovaBank - Banca por Internet Omnicanal`,en:`NovaBank - Omnichannel Internet Banking`},category:{es:`Proyecto profesional banking`,en:`Professional banking project`},description:{es:`Solución omnicanal de banca digital para Internet Banking y Mobile Banking, con administración centralizada y cumplimiento OWASP Top 10.`,en:`Omnichannel digital banking solution for Internet Banking and Mobile Banking, with centralized administration and OWASP Top 10 compliance.`},highlights:{es:[`Construí módulos de transferencia de fondos e integraciones de core bancario para Coopeguanacaste y Coope San Ramón.`,`Implementé funcionalidades backend y frontend sobre flujos de banca por internet para cooperativas.`,`Trabajé bajo criterios de seguridad alineados con OWASP Top 10 para canales web y app.`,`Participé en integraciones orientadas a centralizar cambios en un repositorio de canales omnicanal.`],en:[`Built fund transfer modules and core banking integrations for Coopeguanacaste and Coope San Ramon.`,`Implemented backend and frontend functionality for cooperative internet banking flows.`,`Worked under security criteria aligned with OWASP Top 10 for web and app channels.`,`Contributed to integrations designed to centralize changes in an omnichannel repository.`]},technologies:[`C#`,`.NET`,`Blazor`,`Banking`,`OWASP Top 10`,`Core Banking`],links:[{label:{es:`Ver sitio`,en:`View site`},href:`https://www.in-novative.com/nova-bank/`,primary:!0}],featured:!0},{id:`portfolio`,title:`Portafolio John Castro Sanabria`,category:`Frontend`,description:`Portafolio profesional construido para presentar experiencia, proyectos y contenido técnico con una experiencia rápida, responsive y desplegada en GitHub Pages.`,highlights:[`Arquitectura frontend con React, Vite y React Router`,`Despliegue automatizado hacia GitHub Pages`,`Diseño responsive enfocado en marca personal técnica`,`Secciones de proyectos, experiencia, habilidades y blog`],technologies:[`React`,`TypeScript`,`Vite`,`Tailwind CSS`,`i18next`,`GitHub Pages`],liveDemo:`https://full-stack-dev-johncastrosanabria.github.io/Portfolio/`,githubUrl:`https://github.com/full-stack-dev-johncastrosanabria/Portfolio`,featured:!0},{id:`nova-expediente-novacomp`,title:{es:`NovaExpediente / Novacomp - App corporativa de empleados`,en:`NovaExpediente / Novacomp - Corporate employee app`},category:{es:`Mobile híbrido`,en:`Hybrid mobile`},description:{es:`Aplicación oficial para colaboradores de Novacomp, publicada como NovaExpediente en Android y Novacomp en App Store. Centraliza servicios internos, noticias importantes, denuncias o sugerencias, permisos y trámites empresariales como vacaciones.`,en:`Official Novacomp employee app, published as NovaExpediente on Android and Novacomp on the App Store. It centralizes internal services, important news, complaints or suggestions, permissions and business requests such as vacations.`},highlights:{es:[`App híbrida para iOS y Android con una base de código React Native`,`Módulos para servicios de empleados, noticias, permisos y trámites internos`,`Experiencia móvil orientada a autoservicio corporativo y comunicación interna`,`Publicación en App Store y Google Play con soporte a versiones productivas`],en:[`Hybrid iOS and Android app from one React Native codebase`,`Modules for employee services, news, permissions and internal workflows`,`Mobile experience focused on corporate self-service and internal communication`,`Published on App Store and Google Play with production release support`]},technologies:[`React Native`,`TypeScript`,`React Query`,`Expo`,`iOS`,`Android`,`App Store`,`Google Play`],links:[{label:{es:`App Store`,en:`App Store`},href:`https://apps.apple.com/us/app/novacomp/id1621800757`,primary:!0},{label:{es:`Google Play`,en:`Google Play`},href:`https://play.google.com/store/apps/details?id=com.nova.NovaExpediente`}],featured:!0},{id:`business-ai-analytics`,title:`BusinessAI Analytics - Plataforma BI con IA`,category:`Full Stack AI`,description:{es:`Plataforma local de business intelligence para administrar datos, visualizar dashboards, pronosticar rendimiento con IA y consultar insights mediante chatbot sobre bases de datos y documentos.`,en:`Local business intelligence platform to manage data, visualize dashboards, forecast performance with AI and query insights through a chatbot over databases and documents.`},highlights:{es:[`Arquitectura de microservicios con Spring Boot y Spring Cloud Gateway`,`Servicio de IA en FastAPI con modelos LSTM para pronósticos`,`Frontend SPA en React TypeScript para dashboards e interacción analítica`,`Persistencia en MySQL y módulos separados para productos, clientes, ventas, analítica y documentos`],en:[`Microservices architecture with Spring Boot and Spring Cloud Gateway`,`FastAPI AI service with LSTM models for forecasting`,`React TypeScript SPA for dashboards and analytics interaction`,`MySQL persistence and separated modules for products, customers, sales, analytics and documents`]},technologies:[`Spring Boot`,`Spring Cloud Gateway`,`FastAPI`,`Python`,`React`,`TypeScript`,`MySQL`,`AI`,`LSTM`],links:[{label:{es:`Ver Sitio`,en:`View Site`},href:`https://full-stack-dev-johncastrosanabria.github.io/BusinessAI-Analytics/login`,primary:!0}],liveDemo:`https://www.youtube.com/watch?v=0iG_YRY6oC8`,liveDemoLabel:{es:`Ver Demo`,en:`View Demo`},githubUrl:`https://github.com/full-stack-dev-johncastrosanabria/BusinessAI-Analytics`,featured:!0},{id:`reactivities`,title:`Reactivities - Red Social Full Stack`,category:`Full Stack`,description:`Red social full stack con backend .NET y frontend React, enfocada en actividades, perfiles, comentarios y flujos de interacción en tiempo real.`,highlights:[`Autenticación y autorización con flujo seguro de usuarios`,`Gestión de actividades, comentarios y followers`,`Separación clara entre backend, frontend y capa de datos`,`Base sólida para patrones modernos como CQRS y MediatR`],technologies:[`ASP.NET Core`,`React`,`TypeScript`,`Entity Framework Core`,`SignalR`,`JWT`,`MediatR`],githubUrl:`https://github.com/castrosanabriajohn/Reactivities`,featured:!0},{id:`etickets`,title:`eTickets - Plataforma Cinematográfica`,category:`Full Stack Web`,description:`Aplicación web para venta y administración de entradas de cine, con catálogo, funciones, carrito y gestión de entidades del negocio cinematográfico.`,highlights:[`Arquitectura MVC con ASP.NET Core`,`Gestión de películas, cines, actores y productores`,`Flujo de compra y carrito para entradas`,`Panel administrativo para operación del catálogo`],technologies:[`ASP.NET Core MVC`,`Entity Framework Core`,`SQL Server`,`Bootstrap`,`C#`],githubUrl:`https://github.com/castrosanabriajohn/eTickets`,featured:!0},{id:`admin-dashboard`,title:`Dashboard React`,category:`Frontend`,description:`Dashboard administrativo en React para visualizar métricas, datos y módulos operativos con una interfaz práctica para gestión diaria.`,highlights:[`Diseño de panel administrativo con enfoque en lectura rápida`,`Componentes reutilizables para vistas de datos`,`Estructura preparada para gráficos, tablas y navegación interna`,`Demo pública en vivo con datos de ejemplo`],technologies:[`React`,`JavaScript`,`CSS`,`Dashboard UI`,`Data Visualization`],liveDemo:`https://johns-admin-dashboard-react.netlify.app/`,githubUrl:`https://github.com/castrosanabriajohn/admin-dashboard`},{id:`clean-api`,title:`Interview Clean API - Arquitectura Limpia`,category:`Backend`,description:`API REST diseñada para demostrar criterios de entrevista técnica: separación de capas, validación, documentación y estructura mantenible.`,highlights:[`Arquitectura limpia con límites claros por capa`,`Endpoints REST orientados a pruebas técnicas`,`Validaciones y manejo ordenado de errores`,`Documentación lista para inspección con Swagger/OpenAPI`],technologies:[`ASP.NET Core`,`Clean Architecture`,`REST API`,`Swagger`,`C#`,`SOLID`],githubUrl:`https://github.com/full-stack-dev-johncastrosanabria/InterviewCleanApi`},{id:`basic-business-app`,title:`BasicBusinessApp - API Clean Architecture .NET`,category:`Backend`,description:`Aplicación empresarial base en .NET que usa Clean Architecture para separar dominio, aplicación, infraestructura y presentación.`,highlights:[`Separación de responsabilidades por capas`,`Principios SOLID aplicados a una base empresarial`,`Estructura preparada para testing y evolución`,`Patrones de inyección de dependencias y servicios`],technologies:[`ASP.NET Core`,`Clean Architecture`,`C#`,`SOLID`,`Entity Framework Core`],githubUrl:`https://github.com/castrosanabriajohn/BasicBusinessAppV1`},{id:`propflow`,title:`PropFlow - Landing Page Inmobiliaria`,category:`Frontend`,description:`Landing page inmobiliaria con estética moderna para presentar propiedades, beneficios y llamados a la acción de forma clara.`,highlights:[`Diseño responsive orientado a producto inmobiliario`,`Secciones para beneficios, propiedades y conversión`,`Interfaz limpia con jerarquía visual fuerte`,`Base lista para integración con formularios o CRM`],technologies:[`React`,`TypeScript`,`Tailwind CSS`,`Vite`,`Responsive UI`],liveDemo:`https://full-stack-dev-johncastrosanabria.github.io/PropFlow/`,liveDemoLabel:{es:`Ver Sitio`,en:`View Site`},githubUrl:`https://github.com/full-stack-dev-johncastrosanabria/PropFlow`},{id:`meals-to-go`,title:`MealsToGo - Réplica de Uber Eats`,category:`Mobile`,description:`Proyecto móvil híbrido que replica flujos tipo Uber Eats: exploración de restaurantes, menús, favoritos y experiencia de compra desde React Native.`,highlights:[`Aplicación móvil híbrida con React Native`,`Búsqueda y navegación de restaurantes`,`Persistencia de favoritos y datos de usuario`,`Integración con servicios móviles y mapas`],technologies:[`React Native`,`Expo`,`Firebase`,`Google Maps API`,`Redux`,`Mobile UI`],githubUrl:`https://github.com/castrosanabriajohn/MealsToGo`},{id:`expo-amplify-demo`,title:`Expo Amplify Demo - Mobile + AWS`,category:`Mobile`,description:`Aplicación móvil con React Native y AWS Amplify para explorar autenticación, servicios cloud y backend administrado desde el ecosistema AWS.`,highlights:[`Base móvil con Expo y React Native`,`Integración con AWS Amplify`,`Enfoque en autenticación y backend cloud`,`Proyecto útil para validar arquitectura mobile + cloud`],technologies:[`React Native`,`Expo`,`AWS Amplify`,`GraphQL`,`Cloud`,`Authentication`],githubUrl:`https://github.com/castrosanabriajohn/expo-amplify-demo`},{id:`spring-demo`,title:`Spring Demo - Backend Java`,category:`Backend`,description:`API backend con Spring Boot para demostrar fundamentos de desarrollo Java empresarial, endpoints REST y organización por capas.`,highlights:[`API REST con Spring Boot`,`Estructura backend clara y extensible`,`Validación y manejo de errores`,`Base adecuada para servicios Java modernos`],technologies:[`Spring Boot`,`Java`,`REST API`,`Maven`,`Backend`,`Layered Architecture`],githubUrl:`https://github.com/full-stack-dev-johncastrosanabria/spring-demo`},{id:`vue-project`,title:`Vue Project - Frontend Framework`,category:`Frontend`,description:`Proyecto web en Vue orientado a practicar componentes, estado, rutas y construcción de interfaces modernas con el ecosistema Vue.`,highlights:[`Componentes Vue reutilizables`,`Estructura pensada para vistas y navegación`,`Práctica de patrones frontend modernos`,`Base educativa para escalar a aplicaciones SPA`],technologies:[`Vue`,`JavaScript`,`Vue Router`,`Vite`,`Frontend`,`SPA`],githubUrl:`https://github.com/castrosanabriajohn/vue-project-section10`},{id:`smartgym-api`,title:`SmartGym - Proyecto Universitario PHP`,category:`Backend`,description:`Proyecto universitario en PHP para la gestión de operaciones de gimnasio, con foco en miembros, clases y administración interna.`,highlights:[`Gestión de datos para miembros y servicios`,`Modelo orientado a procesos de gimnasio`,`Backend universitario con estructura CRUD`,`Aplicación práctica de lógica de negocio en PHP`],technologies:[`PHP`,`MySQL`,`Backend`,`CRUD`,`Academic Project`],githubUrl:`https://github.com/castrosanabriajohn/smartgym`},{id:`webapi-matricula`,title:`WebAPI Matrícula - Proyecto Universitario .NET MVC`,category:`Backend`,description:`Sistema universitario .NET para gestión de matrícula, estudiantes y cursos, construido como ejercicio integral de backend académico.`,highlights:[`Gestión de estudiantes, cursos y matrícula`,`Lógica de negocio académica`,`Estructura basada en .NET y MVC/Web API`,`Persistencia de datos con SQL Server`],technologies:[`ASP.NET MVC`,`C#`,`SQL Server`,`Entity Framework`,`Web API`],githubUrl:`https://github.com/castrosanabriajohn/WebAPIMatricula_3C2023`},{id:`wcf-tarjetas`,title:`WCF Servicio Tarjetas - Proyecto Universitario`,category:`Backend`,description:`Servicio WCF universitario para operaciones relacionadas con tarjetas, aplicando comunicación SOAP y conceptos clásicos de servicios distribuidos.`,highlights:[`Servicio distribuido con WCF`,`Contratos SOAP para comunicación entre sistemas`,`Operaciones orientadas a tarjetas`,`Práctica de integración en .NET Framework`],technologies:[`WCF`,`.NET Framework`,`SOAP`,`C#`,`SQL Server`],githubUrl:`https://github.com/castrosanabriajohn/WcfServicioTarjetas_3C2023-Ulacit`},{id:`personas-solution`,title:`PersonasSolution - Gestión de Personas`,category:`Backend`,description:`Solución en Visual Basic para gestionar entidades de personas, pensada como base práctica para operaciones CRUD, separación de capas y persistencia.`,highlights:[`Modelo de dominio centrado en personas`,`Operaciones CRUD organizadas`,`Estructura preparada para extender reglas de negocio`,`Proyecto útil para demostrar fundamentos backend`],technologies:[`Visual Basic`,`CRUD`,`Backend`,`SQL`,`Layered Architecture`],githubUrl:`https://github.com/full-stack-dev-johncastrosanabria/PersonasSolution`},{id:`flask-product-api`,title:`Flask Product API`,category:`Backend`,description:`API ligera en Flask para gestión de productos, ideal para demostrar endpoints REST, simplicidad de Python y construcción rápida de servicios.`,highlights:[`API REST compacta con Flask`,`Gestión de productos mediante endpoints claros`,`Base simple para pruebas, integración o prototipos`,`Demuestra versatilidad fuera del stack .NET`],technologies:[`Python`,`Flask`,`REST API`,`Backend`,`CRUD`],githubUrl:`https://github.com/full-stack-dev-johncastrosanabria/FlaskApiProdcuct`}]].sort((e,t)=>A.indexOf(e.id)-A.indexOf(t.id)),oe=[{title:{es:`Backend empresarial`,en:`Enterprise backend`},description:{es:`Diseño de APIs, servicios y microservicios con foco en arquitectura limpia, seguridad, mantenibilidad e integración.`,en:`API, service and microservice design focused on clean architecture, security, maintainability and integration.`},items:[`C#`,`ASP.NET Core`,`Java`,`Spring Boot`,`Python`,`REST APIs`,`JWT`,`Entity Framework Core`,`MediatR`]},{title:{es:`Arquitectura y calidad`,en:`Architecture and quality`},description:{es:`Buenas prácticas para construir soluciones empresariales limpias y fáciles de evolucionar.`,en:`Best practices for building clean enterprise solutions that are easier to evolve.`},items:{es:[`Clean Architecture`,`Microservicios`,`CQRS`,`SOLID`,`Patrones de diseño`,`Testing mindset`],en:[`Clean Architecture`,`Microservices`,`CQRS`,`SOLID`,`Design patterns`,`Testing mindset`]}},{title:{es:`Frontend y mobile`,en:`Frontend and mobile`},description:{es:`Construcción de interfaces web y móviles modernas conectadas a APIs, con enfoque responsive, accesible y productivo.`,en:`Modern web and mobile interface development connected to APIs, with a responsive, accessible and productive approach.`},items:[`React`,`TypeScript`,`React Native`,`Expo`,`React Query`,`Vue`,`i18next`,`Responsive UI`]},{title:{es:`Cloud, datos e IA`,en:`Cloud, data and AI`},description:{es:`Experiencia integrando datos, automatización, despliegues y soluciones Microsoft Cloud con visión técnica y consultiva.`,en:`Experience integrating data, automation, deployments and Microsoft Cloud solutions with a technical and consultative perspective.`},items:[`Azure`,`Azure DevOps`,`Microsoft Fabric`,`Power Platform`,`SQL Server`,`Oracle`,`MySQL`,`Python`,`FastAPI`,`AI/LSTM`,`CI/CD`]}],se=[{value:{es:`Casi 4 años`,en:`Nearly 4 years`},label:{es:`Experiencia combinada`,en:`Combined experience`},detail:{es:`Casi 4 años de experiencia combinando desarrollo full-stack, Azure DevOps, soluciones Microsoft Cloud y preventa técnica.`,en:`Nearly 4 years of combined experience in full-stack software engineering, Azure DevOps, Microsoft Cloud solutions, and technical pre-sales.`}},{value:`.NET + React`,label:{es:`Perfil híbrido`,en:`Hybrid profile`},detail:{es:`Capacidad para entregar backend, frontend, mobile y conversaciones técnicas de negocio.`,en:`Ability to deliver backend, frontend, mobile and technical business conversations.`}},{value:`Cloud + AI`,label:{es:`Microsoft Cloud e IA`,en:`Microsoft Cloud and AI`},detail:{es:`Azure, DevOps, Fabric, Power Platform e IA aplicada a soluciones empresariales.`,en:`Azure, DevOps, Fabric, Power Platform and AI applied to enterprise solutions.`}}],j=3;function M({label:e,children:t,autoPlayInterval:n=4500,prevLabel:r=`Anterior`,nextLabel:i=`Siguiente`,goToLabel:a=`Ir al elemento`}){let o=(0,S.useMemo)(()=>S.Children.toArray(t),[t]),s=o.length,c=(0,S.useRef)(null),[l,u]=(0,S.useState)(0),[d,f]=(0,S.useState)(!1),p=(0,S.useRef)({startX:0,startScroll:0,dragging:!1}),m=(0,S.useRef)(0),h=typeof window<`u`&&window.matchMedia(`(prefers-reduced-motion: reduce)`).matches,g=(0,S.useCallback)(()=>{let e=c.current;if(!e||e.children.length<2)return e?.clientWidth??0;let t=e.children[0];return e.children[1].offsetLeft-t.offsetLeft},[]),_=(0,S.useCallback)(()=>{let e=c.current;return e?e.scrollWidth/j:0},[]);(0,S.useEffect)(()=>{let e=c.current;!e||s===0||e.scrollTo({left:_(),behavior:`instant`})},[s,_]);let v=(0,S.useCallback)(()=>{let e=c.current;if(!e||s===0)return;let t=_();t!==0&&(e.scrollLeft<t*.5?e.scrollTo({left:e.scrollLeft+t,behavior:`instant`}):e.scrollLeft>t*1.5&&e.scrollTo({left:e.scrollLeft-t,behavior:`instant`}),e.style.scrollSnapType=``)},[s,_]),y=(0,S.useCallback)(e=>{let t=c.current;if(t){if(h){t.scrollTo({left:e,behavior:`instant`});return}t.style.scrollSnapType=`none`,t.scrollTo({left:e,behavior:`smooth`})}},[h]),b=(0,S.useCallback)(()=>{let e=c.current;if(!e||s===0)return;let t=g();if(t>0){let n=Math.round(e.scrollLeft/t)%s;u(n<0?n+s:n)}window.clearTimeout(m.current),m.current=window.setTimeout(v,140)},[s,v,g]),x=(0,S.useCallback)(e=>{let t=c.current;if(!t)return;let n=g();n!==0&&y(Math.round(t.scrollLeft/n)*n+n*e)},[g,y]),C=(0,S.useCallback)(e=>{y(_()+g()*e)},[_,g,y]);(0,S.useEffect)(()=>{if(d||h||s<2)return;let e=window.setInterval(()=>{document.hidden||x(1)},n);return()=>window.clearInterval(e)},[n,s,d,h,x]),(0,S.useEffect)(()=>{let e=c.current;if(!e)return;let t=t=>{Math.abs(t.deltaX)>=Math.abs(t.deltaY)||(t.preventDefault(),e.scrollBy({left:t.deltaY,behavior:`auto`}))};return e.addEventListener(`wheel`,t,{passive:!1}),()=>e.removeEventListener(`wheel`,t)},[]);let T=e=>{if(e.pointerType!==`mouse`)return;let t=c.current;t&&(p.current={startX:e.clientX,startScroll:t.scrollLeft,dragging:!0},t.setPointerCapture(e.pointerId),t.classList.add(`carousel-dragging`))},E=e=>{let t=c.current;!t||!p.current.dragging||(t.scrollLeft=p.current.startScroll-(e.clientX-p.current.startX))},D=e=>{let t=c.current;if(!t||!p.current.dragging)return;p.current.dragging=!1,t.classList.remove(`carousel-dragging`),t.releasePointerCapture(e.pointerId);let n=g();n>0&&y(Math.round(t.scrollLeft/n)*n)};return s===0?null:(0,w.jsxs)(`div`,{className:`carousel`,role:`region`,"aria-roledescription":`carousel`,"aria-label":e,onMouseEnter:()=>f(!0),onMouseLeave:()=>f(!1),onFocus:()=>f(!0),onBlur:()=>f(!1),children:[(0,w.jsx)(`div`,{className:`carousel-track`,ref:c,tabIndex:0,onScroll:b,onKeyDown:e=>{e.key===`ArrowRight`?(e.preventDefault(),x(1)):e.key===`ArrowLeft`&&(e.preventDefault(),x(-1))},onPointerDown:T,onPointerMove:E,onPointerUp:D,onPointerCancel:D,children:Array.from({length:j},(e,t)=>o.map((e,n)=>(0,w.jsx)(`div`,{className:`carousel-slide`,"aria-hidden":t!==1||void 0,children:e},`copy-${t}-slide-${n}`)))}),(0,w.jsxs)(`div`,{className:`carousel-controls`,children:[(0,w.jsx)(`button`,{type:`button`,className:`carousel-arrow`,"aria-label":r,onClick:()=>x(-1),children:(0,w.jsx)(`svg`,{viewBox:`0 0 24 24`,"aria-hidden":`true`,children:(0,w.jsx)(`path`,{d:`m14.5 6.5-5 5.5 5 5.5`,fill:`none`,stroke:`currentColor`,strokeWidth:`2.2`,strokeLinecap:`round`,strokeLinejoin:`round`})})}),(0,w.jsx)(`div`,{className:`carousel-dots`,role:`tablist`,"aria-label":e,children:o.map((e,t)=>(0,w.jsx)(`button`,{type:`button`,role:`tab`,"aria-selected":t===l,"aria-label":`${a} ${t+1}`,className:t===l?`carousel-dot carousel-dot-active`:`carousel-dot`,onClick:()=>C(t)},`dot-${t}`))}),(0,w.jsx)(`button`,{type:`button`,className:`carousel-arrow`,"aria-label":i,onClick:()=>x(1),children:(0,w.jsx)(`svg`,{viewBox:`0 0 24 24`,"aria-hidden":`true`,children:(0,w.jsx)(`path`,{d:`m9.5 6.5 5 5.5-5 5.5`,fill:`none`,stroke:`currentColor`,strokeWidth:`2.2`,strokeLinecap:`round`,strokeLinejoin:`round`})})})]})]})}function N({eyebrow:e,title:t,description:n}){return(0,w.jsxs)(`div`,{className:`section-heading`,children:[e?(0,w.jsx)(`p`,{className:`section-eyebrow`,children:e}):null,(0,w.jsx)(`h2`,{children:t}),n?(0,w.jsx)(`p`,{className:`section-description`,children:n}):null]})}var ce=[{company:`Innovative S.A.`,role:{es:`Practicante de Desarrollo de Software`,en:`Software Development Intern`},period:{es:`Mayo 2022 - Agosto 2022`,en:`May 2022 - August 2022`},startDate:`2022-05-01`,endDate:`2022-08-31`,duration:{es:`4 meses`,en:`4 months`},summary:{es:`San José, CR · Presencial. Construí una solución web y móvil de planillas con backend .NET Core, apps iOS y Android en producción, y una REST API segura.`,en:`San José, CR · On-site. Built a web and mobile payroll solution with a .NET Core backend, iOS and Android apps in production, and a secure REST API.`},description:{es:`Durante mi práctica en Innovative construí una solución integral de planillas web y móvil, con apps iOS y Android en producción, backend en .NET Core y una REST API segura. Diseñé el esquema de SQL Server y los procedimientos almacenados, e integré analítica y monitoreo para uso, rendimiento y seguridad.`,en:`During my internship at Innovative I built an end-to-end web and mobile payroll solution, with iOS and Android apps in production, a .NET Core backend and a secure REST API. I designed the SQL Server schema and stored procedures, and integrated analytics and monitoring for usage, performance and security.`},achievements:{es:[`Construí una solución web y móvil de planillas — app iOS y app Android en producción — con Vue.js, React Native y .NET Core.`,`Diseñé el esquema de SQL Server y los procedimientos almacenados, y entregué una REST API segura.`,`Integré OneSignal, Firebase Analytics y Crashlytics para notificaciones y monitoreo de errores.`,`Analicé datos de uso, rendimiento y seguridad con Python y Power BI.`],en:[`Built a web and mobile payroll solution — iOS app and Android app in production — with Vue.js, React Native and .NET Core.`,`Designed the SQL Server schema and stored procedures, and delivered a secure REST API.`,`Integrated OneSignal, Firebase Analytics and Crashlytics for notifications and error monitoring.`,`Analyzed usage, performance and security data with Python and Power BI.`]},stack:[`.NET Core`,`C#`,`Vue.js`,`React Native`,`SQL Server`,`Firebase`,`Python`,`Power BI`],highlights:[`Full Stack Development`,`Mobile Deployment`,`REST API`]},{company:`Innovative S.A. (Novacomp Group)`,role:{es:`Ingeniero de Software`,en:`Software Engineer`},period:{es:`Octubre 2022 - Setiembre 2025`,en:`October 2022 - September 2025`},startDate:`2022-10-03`,endDate:`2025-09-30`,duration:{es:`2 años 11 meses`,en:`2 years 11 months`},summary:{es:`San José, CR · Híbrido. Construí y mantuve 4 productos SaaS fintech de misión crítica — pagos SINPE, 2FA y banca digital — para bancos, valores y cooperativas certificadas ante el BCCR.`,en:`San José, CR · Hybrid. Built and maintained 4 mission-critical fintech SaaS products — SINPE payments, 2FA and digital banking — for banks, brokerages and BCCR-certified credit unions.`},description:{es:`Como Ingeniero de Software en Innovative construí y mantuve 4 productos SaaS fintech para clientes como Scotiabank, Banco BCT, DiDi, MultiMoney, Improsa Valores, MIDEPLAN, JUPEMA y JPC Solutions, además de cooperativas nacionales. Trabajé sobre stacks de C#/.NET, Java, React y SQL Server, entregando hotfixes en producción y cumpliendo requisitos de reguladores financieros y del Banco Central de Costa Rica.`,en:`As a Software Engineer at Innovative I built and maintained 4 fintech SaaS products for clients including Scotiabank, Banco BCT, DiDi, MultiMoney, Improsa Valores, MIDEPLAN, JUPEMA and JPC Solutions, plus national credit unions. I worked across C#/.NET, Java, React and SQL Server stacks, delivering production hotfixes and meeting financial-regulator and Central Bank of Costa Rica requirements.`},achievements:{es:[`Construí y mantuve 4 productos SaaS fintech para Scotiabank, Banco BCT, DiDi, MultiMoney, Improsa Valores, MIDEPLAN, JUPEMA y JPC Solutions, además de cooperativas nacionales.`,`NovaMP SINPE — Plataforma de Pagos Electrónicos (BCCR): construí módulos de configuración y reportería financiera y entregué hotfixes sosteniendo disponibilidad 24/7 para más de 10 entidades certificadas ante el BCCR.`,`NovaToken — Autenticación de Dos Factores (2FA): desarrollé el BackOffice en React y mantuve la lógica de tokens OTP (expiración de 60 segundos), cumpliendo requisitos de reguladores en LATAM.`,`NovaBank — Banca por Internet Omnicanal: construí módulos de transferencia de fondos e integraciones con core bancario para Coopeguanacaste y Coope San Ramón, conforme con OWASP Top 10.`,`JUPEMA — Gestión Digital de Expedientes: entregué un nuevo sistema de gestión de expedientes y reportería para la Junta de Pensiones del Magisterio Nacional (Java · .NET · Blazor · Oracle).`,`También contribuí a NovaSign (firma y sello digital ante el BCCR), NovaCloud (nube conforme a normativa SINPE) y desarrollo de apps a la medida.`],en:[`Built and maintained 4 fintech SaaS products for Scotiabank, Banco BCT, DiDi, MultiMoney, Improsa Valores, MIDEPLAN, JUPEMA and JPC Solutions, plus national credit unions.`,`NovaMP SINPE — Electronic Payments Platform (BCCR): built configuration and financial-reporting modules and delivered hotfixes sustaining 24/7 uptime for 10+ entities certified by the Central Bank of Costa Rica.`,`NovaToken — Two-Factor Authentication (2FA): developed the React BackOffice and maintained OTP token logic (60-second expiry), meeting financial-regulator requirements across LATAM.`,`NovaBank — Omnichannel Internet Banking: built fund-transfer modules and core-banking integrations for Coopeguanacaste and Coope San Ramón, OWASP Top 10 compliant.`,`JUPEMA — Digital Case Management: delivered a new case-management and reporting system for Costa Rica's National Teachers' Pension Fund (Java · .NET · Blazor · Oracle).`,`Also contributed to NovaSign (BCCR digital signature & sealing), NovaCloud (SINPE-compliant cloud) and custom app development.`]},stack:[`C#`,`.NET`,`.NET Core`,`Java`,`Blazor`,`React`,`SQL Server`,`Oracle`,`T-SQL`,`Stored Procedures`,`OWASP Top 10`,`Git`],highlights:[`Fintech SaaS`,`SINPE / BCCR`,`2FA Security`,`Digital Banking`]},{company:`Servicios Computacionales Novacomp S.A.`,role:{es:`SDR / Ingeniero de Preventa`,en:`SDR / Pre-Sales Engineer`},period:{es:`Octubre 2025 - Febrero 2026`,en:`October 2025 - February 2026`},startDate:`2025-10-01`,endDate:`2026-02-28`,duration:{es:`5 meses`,en:`5 months`},summary:{es:`San José, CR · Híbrido. Rol híbrido de preventa técnica y desarrollo de negocio para soluciones Microsoft Cloud, datos e IA, con un promedio de ~15 reuniones calificadas por mes.`,en:`San José, CR · Hybrid. Hybrid technical pre-sales and business-development role for Microsoft Cloud, data and AI solutions, averaging ~15 qualified meetings per month.`},description:{es:`En Novacomp trabajé en un rol híbrido entre preventa técnica, desarrollo de negocio y consultoría comercial para soluciones Microsoft Cloud. Aproveché mi experiencia full stack para llevar conversaciones técnico-consultivas, traduciendo necesidades de negocio en hojas de ruta de soluciones Microsoft Cloud e IA, y progresé de SDR Tech a preventa independiente.`,en:`At Novacomp I worked in a hybrid role across technical pre-sales, business development and commercial consulting for Microsoft Cloud solutions. I used my full stack background to lead technical-consultative conversations, translating business needs into Microsoft Cloud and AI solution roadmaps, and progressed from SDR Tech to independent pre-sales.`},achievements:{es:[`Generé y califiqué pipeline para soluciones de Azure, Microsoft 365, Power Platform, MS Fabric y Azure DevOps, con un promedio de ~15 reuniones calificadas por mes.`,`Lideré conversaciones técnico-consultivas traduciendo necesidades de negocio en hojas de ruta de soluciones Microsoft Cloud e IA.`,`Progresé a preventa independiente, liderando talleres y propuestas sin supervisión.`,`Aproveché mi experiencia full stack para sostener conversaciones técnicas con clientes y equipos internos.`],en:[`Generated and qualified pipeline for Azure, Microsoft 365, Power Platform, MS Fabric and Azure DevOps solutions, averaging ~15 qualified meetings per month.`,`Led technical-consultative conversations translating business needs into Microsoft Cloud and AI solution roadmaps.`,`Progressed to independent pre-sales, leading workshops and proposals without supervision.`,`Used my full stack background to sustain technical conversations with clients and internal teams.`]},stack:[`Azure`,`Azure DevOps`,`Microsoft Fabric`,`Power Platform`,`Microsoft 365`,`AI Solutions`,`Pre-Sales`,`Business Development`],highlights:[`Microsoft Cloud`,`AI Solutions`,`Technical Pre-Sales`,`Business Development`]},{company:`Innovative S.A. (Novacomp Group)`,role:{es:`Ingeniero de Software`,en:`Software Engineer`},period:{es:`Abril 2026 - Actualidad`,en:`April 2026 - Present`},startDate:`2026-04-01`,endDate:``,duration:{es:`Actualidad`,en:`Present`},summary:{es:`San José, CR · Híbrido. Desarrollo y mantengo sistemas empresariales para clientes del sector financiero sobre Java, .NET, React y SQL Server, aplicando IA y liderando QA automatizado E2E.`,en:`San José, CR · Hybrid. Develop and maintain enterprise systems for financial-sector clients across Java, .NET, React and SQL Server, applying AI and leading automated E2E QA.`},description:{es:`De regreso en Innovative desarrollo y mantengo sistemas empresariales para clientes del sector financiero sobre stacks de Java, .NET, React y SQL Server, con front-ends en TypeScript/JavaScript y herramientas en Python, aplicando IA para ampliar capacidades de producto y acelerar la entrega. Además lidero el aseguramiento de calidad del ciclo de release con pruebas E2E automatizadas.`,en:`Back at Innovative, I develop and maintain enterprise systems for financial-sector clients across Java, .NET, React and SQL Server stacks, with TypeScript/JavaScript front ends and Python tooling, applying AI to extend product capabilities and accelerate delivery. I also lead quality assurance across the release cycle with automated E2E testing.`},achievements:{es:[`Desarrollo y mantengo sistemas empresariales para clientes del sector financiero sobre Java, .NET, React y SQL Server, con front-ends en TypeScript/JavaScript y herramientas en Python.`,`Aplico IA para ampliar las capacidades de producto y acelerar la entrega.`,`Lidero el aseguramiento de calidad del ciclo de release con pruebas E2E automatizadas en Playwright y Selenium — cobertura funcional y de regresión y gestión de defectos.`,`Protejo la confiabilidad de sistemas fintech en producción mediante testing continuo.`],en:[`Develop and maintain enterprise systems for financial-sector clients across Java, .NET, React and SQL Server, with TypeScript/JavaScript front ends and Python tooling.`,`Apply AI to extend product capabilities and accelerate delivery.`,`Lead quality assurance across the release cycle with automated E2E testing in Playwright and Selenium — functional and regression coverage and defect management.`,`Protect the reliability of production fintech systems through continuous testing.`]},stack:[`Java`,`C#`,`.NET`,`React`,`TypeScript`,`SQL Server`,`Python`,`AI Integration`,`Playwright`,`Selenium`],highlights:[`Enterprise Systems`,`AI Integration`,`QA Automation`,`Fintech`]}];function P({children:e}){return(0,w.jsx)(`span`,{className:`tag`,children:e})}var le=[...ce].sort((e,t)=>new Date(t.startDate).getTime()-new Date(e.startDate).getTime());function ue(){let{i18n:e}=d(),t=e.resolvedLanguage||e.language;return(0,w.jsx)(`div`,{className:`timeline`,children:le.map(e=>(0,w.jsxs)(`article`,{className:`timeline-card`,children:[(0,w.jsx)(`div`,{className:`timeline-meta`,children:(0,w.jsx)(`p`,{className:`timeline-period`,children:k(e.period,t)})}),(0,w.jsxs)(`div`,{className:`timeline-body`,children:[(0,w.jsxs)(`div`,{className:`timeline-title`,children:[(0,w.jsx)(`div`,{className:`timeline-dot`}),(0,w.jsx)(`h3`,{children:k(e.role,t)})]}),(0,w.jsx)(`p`,{className:`timeline-company`,children:e.company}),(0,w.jsx)(`p`,{className:`muted`,children:k(e.summary,t)}),(0,w.jsx)(`ul`,{className:`bullet-list`,children:k(e.achievements,t).map(e=>(0,w.jsx)(`li`,{children:e},e))}),(0,w.jsx)(`div`,{className:`tag-group`,children:e.stack.map(e=>(0,w.jsx)(P,{children:e},e))})]})]},`${e.company}-${e.startDate}`))})}function de({certification:e,language:t}){return(0,w.jsxs)(`article`,{className:e.featured?`cert-card cert-card-featured`:`cert-card`,children:[e.image?(0,w.jsxs)(`button`,{className:`cert-media`,type:`button`,"aria-haspopup":`dialog`,"aria-label":`${t===`en`?`View certificate`:`Ver certificado`}: ${k(e.title,t)}`,onClick:()=>{window.dispatchEvent(new CustomEvent(`open-certificate-modal`,{detail:{image:O(e.image||``),title:k(e.title,t)}}))},children:[(0,w.jsx)(`img`,{src:O(e.image),alt:k(e.title,t),loading:`lazy`}),(0,w.jsx)(`span`,{children:t===`en`?`View certificate`:`Ver certificado`})]}):null,(0,w.jsxs)(`div`,{className:`cert-content`,children:[(0,w.jsxs)(`div`,{children:[(0,w.jsx)(`p`,{className:`cert-category`,children:k(e.category,t)}),(0,w.jsx)(`h3`,{children:k(e.title,t)}),(0,w.jsx)(`p`,{className:`cert-issuer`,children:e.issuer})]}),(0,w.jsxs)(`dl`,{className:`cert-meta`,children:[(0,w.jsxs)(`div`,{children:[(0,w.jsx)(`dt`,{children:t===`en`?`Issued`:`Emitido`}),(0,w.jsx)(`dd`,{children:k(e.issuedAt,t)})]}),e.credentialId?(0,w.jsxs)(`div`,{children:[(0,w.jsx)(`dt`,{children:t===`en`?`Credential ID`:`ID de credencial`}),(0,w.jsx)(`dd`,{children:e.credentialId})]}):null,e.certificationNumber?(0,w.jsxs)(`div`,{children:[(0,w.jsx)(`dt`,{children:t===`en`?`Certification number`:`Número de certificación`}),(0,w.jsx)(`dd`,{children:e.certificationNumber})]}):null,e.status?(0,w.jsxs)(`div`,{children:[(0,w.jsx)(`dt`,{children:t===`en`?`Status`:`Estado`}),(0,w.jsx)(`dd`,{children:k(e.status,t)})]}):null,e.hours?(0,w.jsxs)(`div`,{children:[(0,w.jsx)(`dt`,{children:t===`en`?`Duration`:`Duración`}),(0,w.jsx)(`dd`,{children:e.hours})]}):null]})]})]})}function fe(){let[e,t]=(0,S.useState)(null);return(0,S.useEffect)(()=>{let e=e=>{let{detail:n}=e;t(n)};return window.addEventListener(`open-certificate-modal`,e),()=>window.removeEventListener(`open-certificate-modal`,e)},[]),(0,S.useEffect)(()=>{if(!e)return;let n=e=>{e.key===`Escape`&&t(null)};return document.body.classList.add(`modal-open`),window.addEventListener(`keydown`,n),()=>{document.body.classList.remove(`modal-open`),window.removeEventListener(`keydown`,n)}},[e]),e?(0,w.jsx)(`div`,{className:`cert-modal-backdrop`,role:`presentation`,onClick:()=>t(null),children:(0,w.jsxs)(`section`,{className:`cert-modal`,role:`dialog`,"aria-modal":`true`,"aria-label":e.title,onClick:e=>e.stopPropagation(),children:[(0,w.jsxs)(`header`,{className:`cert-modal-header`,children:[(0,w.jsx)(`h2`,{children:e.title}),(0,w.jsx)(`button`,{type:`button`,onClick:()=>t(null),"aria-label":`Cerrar`,children:`×`})]}),(0,w.jsx)(`div`,{className:`cert-modal-media`,children:(0,w.jsx)(`img`,{src:e.image,alt:e.title})})]})}):null}function pe(){let e=(0,S.useRef)(null);return(0,S.useEffect)(()=>{let t=e.current;if(!t)return;let n=t.getContext(`2d`);if(!n)return;let r=window.matchMedia(`(prefers-reduced-motion: reduce)`).matches,i=Math.min(window.devicePixelRatio||1,2),a=0,o=0,s=[],c={x:-9999,y:-9999,active:!1},l=0,u=!1,d=()=>getComputedStyle(t).getPropertyValue(`--hero-node`).trim()||`56, 189, 248`,f=d(),p=()=>Math.min(160,Math.max(110,a/9));function m(){let e=t.getBoundingClientRect();a=e.width,o=e.height,t.width=Math.round(a*i),t.height=Math.round(o*i),n.setTransform(i,0,0,i,0,0);let r=Math.min(64,Math.round(a*o/16e3));f=d(),s=Array.from({length:r},()=>({x:Math.random()*a,y:Math.random()*o,vx:(Math.random()-.5)*.28,vy:(Math.random()-.5)*.28}))}function h(){let e=p();n.clearRect(0,0,a,o);for(let e of s){if(e.x+=e.vx,e.y+=e.vy,(e.x<0||e.x>a)&&(e.vx*=-1),(e.y<0||e.y>o)&&(e.vy*=-1),c.active){let t=c.x-e.x,n=c.y-e.y,r=t*t+n*n;if(r<26e3&&r>1){let i=.18/Math.sqrt(r);e.vx+=t*i*.02,e.vy+=n*i*.02}}e.vx=Math.max(-.6,Math.min(.6,e.vx*.995)),e.vy=Math.max(-.6,Math.min(.6,e.vy*.995))}for(let t=0;t<s.length;t++)for(let r=t+1;r<s.length;r++){let i=s[t],a=s[r],o=i.x-a.x,c=i.y-a.y,l=Math.hypot(o,c);if(l<e){let t=(1-l/e)*.42;n.strokeStyle=`rgba(${f}, ${t.toFixed(3)})`,n.lineWidth=1,n.beginPath(),n.moveTo(i.x,i.y),n.lineTo(a.x,a.y),n.stroke()}}n.shadowBlur=8,n.shadowColor=`rgba(${f}, 0.9)`,n.fillStyle=`rgba(${f}, 0.95)`;for(let e of s)n.beginPath(),n.arc(e.x,e.y,1.7,0,Math.PI*2),n.fill();n.shadowBlur=0}function g(){h(),l=requestAnimationFrame(g)}function _(){u||r||(u=!0,l=requestAnimationFrame(g))}function v(){u=!1,cancelAnimationFrame(l)}m(),r?h():_();let y=()=>{m(),r&&h()},b=e=>{let n=t.getBoundingClientRect(),r=e.clientX-n.left,i=e.clientY-n.top;c.active=r>=0&&r<=n.width&&i>=0&&i<=n.height,c.x=r,c.y=i},x=()=>{c.active=!1},S=()=>{document.hidden?v():_()},C=new IntersectionObserver(([e])=>{e.isIntersecting?_():v()},{threshold:0});return C.observe(t),window.addEventListener(`resize`,y),window.addEventListener(`pointermove`,b,{passive:!0}),window.addEventListener(`blur`,x),document.addEventListener(`visibilitychange`,S),()=>{v(),C.disconnect(),window.removeEventListener(`resize`,y),window.removeEventListener(`pointermove`,b),window.removeEventListener(`blur`,x),document.removeEventListener(`visibilitychange`,S)}},[]),(0,w.jsx)(`canvas`,{ref:e,className:`hero-canvas`,"aria-hidden":`true`})}function F({name:e}){return e===`github`?(0,w.jsx)(`img`,{src:`/Portfolio/github-mark.svg`,alt:``,"aria-hidden":`true`}):e===`youtube`?(0,w.jsxs)(`svg`,{viewBox:`0 0 24 24`,"aria-hidden":`true`,children:[(0,w.jsx)(`path`,{d:`M21.6 7.2a3 3 0 0 0-2.1-2.1C17.6 4.6 12 4.6 12 4.6s-5.6 0-7.5.5a3 3 0 0 0-2.1 2.1A31 31 0 0 0 2 12a31 31 0 0 0 .4 4.8 3 3 0 0 0 2.1 2.1c1.9.5 7.5.5 7.5.5s5.6 0 7.5-.5a3 3 0 0 0 2.1-2.1A31 31 0 0 0 22 12a31 31 0 0 0-.4-4.8Z`}),(0,w.jsx)(`path`,{d:`m10.2 15.4 5-3.4-5-3.4v6.8Z`,fill:`currentColor`})]}):e===`download`?(0,w.jsxs)(`svg`,{viewBox:`0 0 24 24`,"aria-hidden":`true`,children:[(0,w.jsx)(`path`,{d:`M12 3a1.4 1.4 0 0 1 1.4 1.4v7.1l2.1-2.1a1.4 1.4 0 1 1 2 2L13 15.9a1.4 1.4 0 0 1-2 0l-4.5-4.5a1.4 1.4 0 0 1 2-2l2.1 2.1V4.4A1.4 1.4 0 0 1 12 3Z`}),(0,w.jsx)(`path`,{d:`M5.4 18.2c0-.8.6-1.4 1.4-1.4h10.4a1.4 1.4 0 1 1 0 2.8H6.8c-.8 0-1.4-.6-1.4-1.4Z`})]}):e===`document`?(0,w.jsxs)(`svg`,{viewBox:`0 0 24 24`,"aria-hidden":`true`,children:[(0,w.jsx)(`path`,{d:`M6.8 2.5h6.5L19 8.2v13.3H6.8A1.8 1.8 0 0 1 5 19.7V4.3a1.8 1.8 0 0 1 1.8-1.8Zm6 1.8v4.4h4.4`,fill:`none`,stroke:`currentColor`,strokeWidth:`2`,strokeLinejoin:`round`}),(0,w.jsx)(`path`,{d:`M8.5 12h7M8.5 15.5h7M8.5 8.5h2.8`,fill:`none`,stroke:`currentColor`,strokeWidth:`2`,strokeLinecap:`round`})]}):(0,w.jsxs)(`svg`,{viewBox:`0 0 24 24`,"aria-hidden":`true`,children:[(0,w.jsx)(`path`,{d:`M3 6.3c0-1 .8-1.8 1.8-1.8h5l1.8 2.2h7.6c1 0 1.8.8 1.8 1.8v9.2c0 1-.8 1.8-1.8 1.8H4.8c-1 0-1.8-.8-1.8-1.8V6.3Z`,fill:`none`,stroke:`currentColor`,strokeWidth:`2`,strokeLinejoin:`round`}),(0,w.jsx)(`path`,{d:`M3 9h18`,fill:`none`,stroke:`currentColor`,strokeWidth:`2`,strokeLinecap:`round`})]})}var me={portfolio:{title:{en:`John Castro Sanabria Portfolio`},description:{en:`Professional portfolio built to present experience, projects and technical content with a fast, responsive experience deployed on GitHub Pages.`},highlights:{en:[`Frontend architecture with React, Vite and React Router`,`Automated deployment to GitHub Pages`,`Responsive design focused on a technical personal brand`,`Projects, experience, skills and blog sections`]}},"business-ai-analytics":{title:{en:`BusinessAI Analytics - AI BI Platform`}},reactivities:{title:{en:`Reactivities - Full Stack Social Network`},description:{en:`Full stack social network with a .NET backend and React frontend, focused on activities, profiles, comments and real-time interaction flows.`},highlights:{en:[`Authentication and authorization with secure user flows`,`Activity, comment and follower management`,`Clear separation between backend, frontend and data layers`,`Solid foundation for modern patterns such as CQRS and MediatR`]}},etickets:{title:{en:`eTickets - Movie Ticketing Platform`},description:{en:`Web application for selling and managing movie tickets, with catalog, showtimes, cart and management of cinema business entities.`},highlights:{en:[`MVC architecture with ASP.NET Core`,`Movie, cinema, actor and producer management`,`Ticket purchase and cart flow`,`Admin panel for catalog operations`]}},"admin-dashboard":{description:{en:`React admin dashboard for visualizing metrics, data and operational modules with a practical interface for daily management.`},highlights:{en:[`Admin panel design focused on fast reading`,`Reusable components for data views`,`Structure prepared for charts, tables and internal navigation`,`Public live demo with sample data`]}},"clean-api":{title:{en:`Interview Clean API - Clean Architecture`},description:{en:`REST API designed to demonstrate technical interview criteria: layer separation, validation, documentation and maintainable structure.`},highlights:{en:[`Clean architecture with clear layer boundaries`,`REST endpoints oriented to technical exercises`,`Validation and organized error handling`,`Inspection-ready documentation with Swagger/OpenAPI`]}},"basic-business-app":{description:{en:`Base enterprise application in .NET using Clean Architecture to separate domain, application, infrastructure and presentation.`},highlights:{en:[`Layered separation of responsibilities`,`SOLID principles applied to an enterprise foundation`,`Structure prepared for testing and evolution`,`Dependency injection and service patterns`]}},propflow:{title:{en:`PropFlow - Real Estate Landing Page`},description:{en:`Real estate landing page with a modern aesthetic for presenting properties, benefits and calls to action clearly.`},highlights:{en:[`Responsive design oriented to real estate products`,`Sections for benefits, properties and conversion`,`Clean interface with strong visual hierarchy`,`Base ready for form or CRM integration`]}},"meals-to-go":{title:{en:`MealsToGo - Uber Eats Clone`},description:{en:`Hybrid mobile project that recreates Uber Eats-style flows: restaurant discovery, menus, favorites and purchase experience from React Native.`},highlights:{en:[`Hybrid mobile app with React Native`,`Restaurant search and navigation`,`Favorites and user data persistence`,`Integration with mobile services and maps`]}},"expo-amplify-demo":{description:{en:`Mobile application with React Native and AWS Amplify to explore authentication, cloud services and managed backend capabilities in the AWS ecosystem.`},highlights:{en:[`Mobile foundation with Expo and React Native`,`AWS Amplify integration`,`Focus on authentication and cloud backend`,`Useful project for validating mobile + cloud architecture`]}},"spring-demo":{description:{en:`Backend API with Spring Boot to demonstrate enterprise Java development fundamentals, REST endpoints and layered organization.`},highlights:{en:[`REST API with Spring Boot`,`Clear and extensible backend structure`,`Validation and error handling`,`Solid base for modern Java services`]}},"vue-project":{description:{en:`Vue web project focused on practicing components, state, routes and modern interface construction with the Vue ecosystem.`},highlights:{en:[`Reusable Vue components`,`Structure designed for views and navigation`,`Practice of modern frontend patterns`,`Educational base for scaling into SPA applications`]}},"smartgym-api":{title:{en:`SmartGym - University PHP Project`},description:{en:`University PHP project for managing gym operations, focused on members, classes and internal administration.`},highlights:{en:[`Data management for members and services`,`Model oriented to gym processes`,`University backend with CRUD structure`,`Practical application of business logic in PHP`]}},"webapi-matricula":{title:{en:`Enrollment WebAPI - University .NET MVC Project`},description:{en:`University .NET system for managing enrollment, students and courses, built as a comprehensive academic backend exercise.`},highlights:{en:[`Student, course and enrollment management`,`Academic business logic`,`Structure based on .NET and MVC/Web API`,`Data persistence with SQL Server`]}},"wcf-tarjetas":{title:{en:`WCF Card Service - University Project`},description:{en:`University WCF service for card-related operations, applying SOAP communication and classic distributed service concepts.`},highlights:{en:[`Distributed service with WCF`,`SOAP contracts for system-to-system communication`,`Card-oriented operations`,`Integration practice in .NET Framework`]}},"personas-solution":{title:{en:`PersonasSolution - People Management`},description:{en:`Visual Basic solution for managing people entities, designed as a practical base for CRUD operations, layer separation and persistence.`},highlights:{en:[`Domain model centered on people`,`Organized CRUD operations`,`Structure prepared to extend business rules`,`Useful project for demonstrating backend fundamentals`]}},"flask-product-api":{description:{en:`Lightweight Flask API for product management, useful for demonstrating REST endpoints, Python simplicity and fast service construction.`},highlights:{en:[`Compact REST API with Flask`,`Product management through clear endpoints`,`Simple base for testing, integration or prototypes`,`Demonstrates versatility outside the .NET stack`]}}};function he(e,t){let n=e.toLowerCase(),r=t.toLowerCase();return n.includes(`app store`)||r.includes(`apps.apple.com`)?`app-store`:n.includes(`google play`)||r.includes(`play.google.com`)?`play-store`:`external`}function I(e,t){let n=e.toLowerCase(),r=t.toLowerCase();return n.includes(`demo`)||r.includes(`youtube.com`)||r.includes(`youtu.be`)?`demo`:`site`}function ge(e,t){let n=e.toLowerCase();return n.includes(`ver sitio`)||n.includes(`view site`)?`button-site`:t?`button-primary`:`button-secondary`}function L({name:e}){return e===`app-store`?(0,w.jsx)(`img`,{src:O(`app-store-mark.svg`),alt:``,"aria-hidden":`true`}):e===`play-store`?(0,w.jsxs)(`svg`,{viewBox:`0 0 24 24`,"aria-hidden":`true`,children:[(0,w.jsx)(`circle`,{cx:`12`,cy:`12`,r:`10`,fill:`#ffffff`}),(0,w.jsx)(`path`,{d:`M7.1 5.3c-.4.2-.7.6-.7 1.2v11c0 .6.3 1 .7 1.2l6-6.7-6-6.7Z`,fill:`#3bccff`}),(0,w.jsx)(`path`,{d:`m13.9 11.1 2.1-2.4-7.6-4.2c-.4-.2-.8-.1-1.1.1l6.6 6.5Z`,fill:`#00d87f`}),(0,w.jsx)(`path`,{d:`m13.9 12.9-6.6 6.5c.3.2.8.3 1.1.1l7.6-4.2-2.1-2.4Z`,fill:`#ff3d48`}),(0,w.jsx)(`path`,{d:`m16.7 9.1 2.2 1.2c1 .5 1 1.9 0 2.4l-2.2 1.2-2.5-1.9 2.5-2.9Z`,fill:`#ffcd2e`})]}):e===`demo`?(0,w.jsxs)(`svg`,{viewBox:`0 0 24 24`,"aria-hidden":`true`,children:[(0,w.jsx)(`circle`,{cx:`12`,cy:`12`,r:`8.4`,fill:`none`,stroke:`currentColor`,strokeWidth:`2`}),(0,w.jsx)(`path`,{d:`m10.5 8.8 5.1 3.2-5.1 3.2V8.8Z`})]}):e===`site`?(0,w.jsxs)(`svg`,{viewBox:`0 0 24 24`,"aria-hidden":`true`,children:[(0,w.jsx)(`rect`,{x:`4`,y:`5`,width:`16`,height:`14`,rx:`3`,fill:`none`,stroke:`currentColor`,strokeWidth:`2`}),(0,w.jsx)(`path`,{d:`M4.7 9h14.6`,fill:`none`,stroke:`currentColor`,strokeLinecap:`round`,strokeWidth:`2`}),(0,w.jsx)(`path`,{d:`M10.2 14h4.9m0 0-2-2m2 2-2 2`,fill:`none`,stroke:`currentColor`,strokeLinecap:`round`,strokeLinejoin:`round`,strokeWidth:`2`})]}):e===`code`?(0,w.jsxs)(`svg`,{viewBox:`0 0 24 24`,"aria-hidden":`true`,children:[(0,w.jsx)(`rect`,{x:`4`,y:`5`,width:`16`,height:`14`,rx:`3`,fill:`none`,stroke:`currentColor`,strokeWidth:`2`}),(0,w.jsx)(`path`,{d:`M4.7 9h14.6`,fill:`none`,stroke:`currentColor`,strokeLinecap:`round`,strokeWidth:`2`}),(0,w.jsx)(`path`,{d:`m10 13-2 2 2 2`,fill:`none`,stroke:`currentColor`,strokeLinecap:`round`,strokeLinejoin:`round`,strokeWidth:`2`}),(0,w.jsx)(`path`,{d:`m14 13 2 2-2 2`,fill:`none`,stroke:`currentColor`,strokeLinecap:`round`,strokeLinejoin:`round`,strokeWidth:`2`})]}):(0,w.jsxs)(`svg`,{viewBox:`0 0 24 24`,"aria-hidden":`true`,children:[(0,w.jsx)(`path`,{d:`M8 7h8.6v8.6`,fill:`none`,stroke:`currentColor`,strokeLinecap:`round`,strokeLinejoin:`round`,strokeWidth:`2.2`}),(0,w.jsx)(`path`,{d:`m16.2 7.4-9 9`,fill:`none`,stroke:`currentColor`,strokeLinecap:`round`,strokeWidth:`2.2`})]})}function _e({project:e,language:t}){let{t:n,i18n:r}=d(),i=t||r.resolvedLanguage||r.language,a=e.links??[],o=i===`en`?me[e.id]:void 0,s=o?.title??e.title,c=o?.category??e.category,l=o?.description??e.description,u=o?.highlights??e.highlights,f=e.liveDemoLabel?k(e.liveDemoLabel,i):n(`projectLinks.live`);return(0,w.jsxs)(`article`,{className:`project-card`,children:[(0,w.jsx)(`p`,{className:`project-category`,children:k(c,i)}),(0,w.jsx)(`h3`,{children:k(s,i)}),(0,w.jsx)(`p`,{className:`muted`,children:k(l,i)}),(0,w.jsx)(`ul`,{className:`bullet-list`,children:k(u,i).map(e=>(0,w.jsx)(`li`,{children:e},e))}),(0,w.jsx)(`div`,{className:`tag-group`,children:e.technologies.map(e=>(0,w.jsx)(P,{children:e},e))}),(e.liveDemo||e.githubUrl||a.length>0)&&(0,w.jsxs)(`div`,{className:`project-links`,children:[e.liveDemo&&(0,w.jsxs)(`a`,{className:`button button-primary ${I(f,e.liveDemo)===`site`?`button-site`:`button-demo`}`,href:e.liveDemo,target:`_blank`,rel:`noopener noreferrer`,title:f,children:[(0,w.jsx)(`span`,{className:`button-icon`,"aria-hidden":`true`,children:(0,w.jsx)(L,{name:I(f,e.liveDemo)})}),(0,w.jsx)(`span`,{children:f})]}),e.githubUrl&&(0,w.jsxs)(`a`,{className:`button button-secondary`,href:e.githubUrl,target:`_blank`,rel:`noopener noreferrer`,title:n(`projectLinks.code`),children:[(0,w.jsx)(`span`,{className:`button-icon`,"aria-hidden":`true`,children:(0,w.jsx)(L,{name:`code`})}),(0,w.jsx)(`span`,{children:n(`projectLinks.code`)})]}),a.map(e=>{let t=k(e.label,i);return(0,w.jsxs)(`a`,{className:`button ${ge(t,e.primary)}`,href:e.href,target:`_blank`,rel:`noopener noreferrer`,title:t,children:[(0,w.jsx)(`span`,{className:`button-icon`,"aria-hidden":`true`,children:(0,w.jsx)(L,{name:he(t,e.href)})}),(0,w.jsx)(`span`,{children:t})]},e.href)})]})]})}function ve({title:e,description:t,items:n,language:r}){let i=k(n,r);return(0,w.jsxs)(`article`,{className:`skill-card`,children:[(0,w.jsx)(`h3`,{children:k(e,r)}),(0,w.jsx)(`p`,{className:`muted`,children:k(t,r)}),(0,w.jsx)(`div`,{className:`tag-group`,children:i.map(e=>(0,w.jsx)(P,{children:e},e))})]})}function ye({value:e,label:t,detail:n,language:r}){return(0,w.jsxs)(`article`,{className:`stat-card`,children:[(0,w.jsx)(`p`,{className:`stat-value`,children:k(e,r)}),(0,w.jsx)(`p`,{className:`stat-label`,children:k(t,r)}),(0,w.jsx)(`p`,{className:`muted`,children:k(n,r)})]})}function R(e,t=` | John Castro Sanabria`){(0,S.useEffect)(()=>{let n=e?`${e}${t}`:`John Castro Sanabria - Ingeniero de software full-stack`;document.title=n;let r=document.querySelector(`meta[property="og:title"]`);r&&r.setAttribute(`content`,n)},[e,t])}function be(){R(`Portafolio | Ingeniero de software full-stack`);let{t:e,i18n:n}=d(),r=n.resolvedLanguage||n.language,i=e(`hero.bullets`,{returnObjects:!0});return(0,w.jsxs)(w.Fragment,{children:[(0,w.jsxs)(`section`,{className:`hero-section`,children:[(0,w.jsx)(pe,{}),(0,w.jsxs)(`div`,{className:`container hero-grid`,children:[(0,w.jsxs)(`div`,{children:[(0,w.jsx)(`p`,{className:`section-eyebrow`,children:e(`hero.eyebrow`)}),(0,w.jsx)(`h1`,{children:E.author}),(0,w.jsx)(`p`,{className:`hero-role`,children:k(E.roleLocalized,r)}),(0,w.jsx)(`p`,{className:`hero-copy`,children:k(E.headlineLocalized,r)}),(0,w.jsxs)(`div`,{className:`hero-actions`,children:[(0,w.jsxs)(`a`,{className:`button hero-button hero-button-primary`,href:`#proyectos`,children:[(0,w.jsx)(`span`,{className:`hero-button-icon`,"aria-hidden":`true`,children:(0,w.jsx)(F,{name:`folder`})}),(0,w.jsx)(`span`,{children:k(E.ctaPrimaryLocalized,r)})]}),(0,w.jsxs)(t,{className:`button hero-button hero-button-secondary`,to:`/blog`,viewTransition:!0,children:[(0,w.jsx)(`span`,{className:`hero-button-icon`,"aria-hidden":`true`,children:(0,w.jsx)(F,{name:`document`})}),(0,w.jsx)(`span`,{children:k(E.ctaSecondaryLocalized,r)})]}),(0,w.jsxs)(`details`,{className:`resume-download`,children:[(0,w.jsxs)(`summary`,{className:`button hero-button hero-button-secondary`,children:[(0,w.jsx)(`span`,{className:`hero-button-icon`,"aria-hidden":`true`,children:(0,w.jsx)(F,{name:`download`})}),(0,w.jsx)(`span`,{children:e(`hero.resumeButton`)})]}),(0,w.jsxs)(`div`,{className:`resume-options`,"aria-label":e(`hero.resumeQuestion`),children:[(0,w.jsx)(`span`,{children:e(`hero.resumeQuestion`)}),(0,w.jsx)(`a`,{href:O(E.resumeDownloads.es),download:`John_Castro_Sanabria_CV_ES.pdf`,children:e(`hero.resumeSpanish`)}),(0,w.jsx)(`a`,{href:O(E.resumeDownloads.en),download:`John_Castro_Sanabria_CV_EN.pdf`,children:e(`hero.resumeEnglish`)})]})]})]}),(0,w.jsxs)(`div`,{className:`hero-social-actions`,"aria-label":`Canales profesionales`,children:[(0,w.jsxs)(`a`,{className:`button button-youtube`,href:E.youtubeUrl,target:`_blank`,rel:`noopener noreferrer`,children:[(0,w.jsx)(`span`,{className:`button-icon button-icon-youtube`,"aria-hidden":`true`,children:(0,w.jsx)(F,{name:`youtube`})}),(0,w.jsx)(`span`,{className:`button-label`,children:k(E.ctaYouTubeLocalized,r)})]}),(0,w.jsxs)(`a`,{className:`button button-github`,href:E.githubProfileUrl,target:`_blank`,rel:`noopener noreferrer`,children:[(0,w.jsx)(`span`,{className:`button-icon button-icon-github`,"aria-hidden":`true`,children:(0,w.jsx)(F,{name:`github`})}),(0,w.jsx)(`span`,{className:`button-label`,children:k(E.ctaGitHubLocalized,r)})]})]})]}),(0,w.jsxs)(`aside`,{className:`hero-card hero-profile-card`,children:[(0,w.jsx)(`div`,{className:`hero-profile-media`,children:(0,w.jsx)(`img`,{src:O(`profile-john.png`),alt:`John Castro en oficina`})}),(0,w.jsxs)(`div`,{className:`hero-profile-copy`,children:[(0,w.jsx)(`p`,{className:`hero-card-label`,children:e(`hero.profile`)}),(0,w.jsx)(`h2`,{children:e(`hero.profileTitle`)}),(0,w.jsx)(`p`,{className:`hero-profile-text`,children:e(`hero.profileText`)}),(0,w.jsx)(`ul`,{className:`bullet-list hero-bullet-list`,children:i.map(e=>(0,w.jsx)(`li`,{children:e},e))})]})]})]})]}),(0,w.jsx)(`section`,{className:`section section-tight-top`,children:(0,w.jsx)(`div`,{className:`container stats-grid`,children:se.map(e=>(0,w.jsx)(ye,{value:e.value,label:e.label,detail:e.detail,language:r},k(e.label,`es`)))})}),(0,w.jsx)(`section`,{className:`section`,children:(0,w.jsxs)(`div`,{className:`container`,children:[(0,w.jsx)(N,{eyebrow:e(`sections.stackEyebrow`),title:e(`sections.stackTitle`),description:e(`sections.stackDescription`)}),(0,w.jsx)(M,{label:e(`sections.stackTitle`),prevLabel:e(`carousel.previous`),nextLabel:e(`carousel.next`),goToLabel:e(`carousel.goTo`),children:oe.map(e=>(0,w.jsx)(ve,{...e,language:r},k(e.title,`es`)))})]})}),(0,w.jsx)(`section`,{className:`section`,children:(0,w.jsxs)(`div`,{className:`container`,children:[(0,w.jsx)(N,{eyebrow:e(`sections.certificationsEyebrow`),title:e(`sections.certificationsTitle`),description:e(`sections.certificationsDescription`)}),(0,w.jsx)(M,{label:e(`sections.certificationsTitle`),prevLabel:e(`carousel.previous`),nextLabel:e(`carousel.next`),goToLabel:e(`carousel.goTo`),children:ie.map(e=>(0,w.jsx)(de,{certification:e,language:r},e.id))})]})}),(0,w.jsx)(`section`,{className:`section`,children:(0,w.jsxs)(`div`,{className:`container`,children:[(0,w.jsx)(N,{eyebrow:e(`sections.experienceEyebrow`),title:e(`sections.experienceTitle`),description:e(`sections.experienceDescription`)}),(0,w.jsx)(ue,{})]})}),(0,w.jsx)(`section`,{className:`section`,id:`proyectos`,children:(0,w.jsxs)(`div`,{className:`container`,children:[(0,w.jsx)(N,{eyebrow:e(`sections.projectsEyebrow`),title:e(`sections.projectsTitle`),description:e(`sections.projectsDescription`)}),(0,w.jsx)(`div`,{className:`card-grid`,children:ae.map(e=>(0,w.jsx)(_e,{project:e,language:r},e.id))})]})}),(0,w.jsx)(`section`,{className:`section section-accent`,children:(0,w.jsxs)(`div`,{className:`container cta-panel`,children:[(0,w.jsxs)(`div`,{children:[(0,w.jsx)(`p`,{className:`section-eyebrow`,children:e(`sections.blogEyebrow`)}),(0,w.jsx)(`h2`,{children:e(`sections.blogTitle`)}),(0,w.jsx)(`p`,{className:`section-description`,children:e(`sections.blogDescription`)})]}),(0,w.jsx)(t,{className:`button`,to:`/blog`,viewTransition:!0,children:e(`sections.blogButton`)})]})}),(0,w.jsx)(fe,{})]})}function z(e,t=`es`){return new Intl.DateTimeFormat(t===`en`?`en-US`:`es-ES`,{day:`2-digit`,month:`long`,year:`numeric`}).format(new Date(e))}function xe(e,t){return e.slug===t}function Se({post:e}){let{t:n,i18n:r}=d(),i=r.resolvedLanguage||r.language;return(0,w.jsxs)(`article`,{className:`blog-card`,children:[(0,w.jsxs)(`div`,{className:`blog-card-top`,children:[(0,w.jsxs)(`p`,{className:`blog-meta`,children:[(0,w.jsx)(`span`,{children:z(e.publishedAt,i)}),(0,w.jsx)(`span`,{children:`•`}),(0,w.jsx)(`span`,{children:e.readingTime}),(0,w.jsx)(`span`,{children:`•`}),(0,w.jsx)(`span`,{children:e.source===`firebase`?`Firebase`:n(`blog.sourceLocal`)})]}),(0,w.jsx)(`h3`,{children:e.title}),(0,w.jsx)(`p`,{className:`muted`,children:e.excerpt})]}),(0,w.jsx)(`div`,{className:`tag-group`,children:e.tags.map(e=>(0,w.jsx)(P,{children:e},e))}),(0,w.jsx)(t,{className:`button button-secondary`,to:`/blog/${e.slug}`,children:n(`blog.readArticle`)})]})}function Ce({search:e,onSearchChange:t,selectedTag:n,onTagChange:r,availableTags:i}){let{t:a}=d();return(0,w.jsxs)(`div`,{className:`filters-panel`,children:[(0,w.jsxs)(`label`,{className:`field`,children:[(0,w.jsx)(`span`,{children:a(`blog.search`)}),(0,w.jsx)(`input`,{type:`search`,value:e,onChange:e=>t(e.target.value),placeholder:a(`blog.searchPlaceholder`)})]}),(0,w.jsxs)(`label`,{className:`field`,children:[(0,w.jsx)(`span`,{children:a(`blog.tag`)}),(0,w.jsxs)(`select`,{value:n,onChange:e=>r(e.target.value),children:[(0,w.jsx)(`option`,{value:`all`,children:a(`blog.all`)}),i.map(e=>(0,w.jsx)(`option`,{value:e,children:e},e))]})]})]})}function B({title:e,description:t}){return(0,w.jsxs)(`div`,{className:`empty-state`,children:[(0,w.jsx)(`h3`,{children:e}),(0,w.jsx)(`p`,{children:t})]})}function we({label:e=`Cargando contenido...`}){return(0,w.jsxs)(`div`,{className:`loader`,role:`status`,"aria-live":`polite`,children:[(0,w.jsx)(`span`,{className:`loader-dot`}),(0,w.jsx)(`p`,{children:e})]})}var V={apiKey:void 0,authDomain:void 0,projectId:void 0,storageBucket:void 0,messagingSenderId:void 0,appId:void 0,measurementId:void 0},H=[`apiKey`,`authDomain`,`projectId`,`appId`].every(e=>!!V[e]);function Te(){return H?b().length?v():m(V):null}var U=Te(),W=U?y(U):null,Ee=[{id:`1`,slug:`net-10-features-2026`,title:`.NET 10: Nuevas características y mejoras de performance`,excerpt:`.NET 10 trae mejoras significativas en performance, seguridad y herramientas de desarrollo. Descubre las características clave que debes conocer.`,content:`
...
Buenas integraciones nacen de buenos contratos. Cuando la API y el frontend se entienden bien, el producto se siente más rápido, confiable y profesional.
    `,tags:[`API Design`,`UX`,`Frontend`,`Backend`],publishedAt:`2026-04-22`,readingTime:`5 min`,source:`local`}];function G(e,t=`local`){if(`data`in e){let n=e.data();return{id:e.id,slug:n.slug??e.id,title:n.title??``,excerpt:n.excerpt??``,content:n.content??``,tags:n.tags??[],publishedAt:n.publishedAt??new Date().toISOString(),readingTime:n.readingTime??`4 min`,source:t}}return{...e,source:t}}function K(){let[e,t]=(0,S.useState)(Ee.map(e=>G(e))),[n,r]=(0,S.useState)(H),[i,a]=(0,S.useState)(``);return(0,S.useEffect)(()=>{async function e(){if(!H||!W){r(!1);return}try{let e=await _(p(x(W,`posts`),h(`publishedAt`,`desc`)));e.empty||t(e.docs.map(e=>G(e,`firebase`)))}catch(e){console.warn(`No se pudieron cargar los posts desde Firebase. Se usarán los locales.`,e),a(`blog.firebaseFallback`)}finally{r(!1)}}e()},[]),{posts:(0,S.useMemo)(()=>[...e].sort((e,t)=>new Date(t.publishedAt).getTime()-new Date(e.publishedAt).getTime()),[e]),isLoading:n,error:i}}var De={en:{1:{title:`.NET 10: New features and performance improvements`,excerpt:`.NET 10 brings meaningful improvements in performance, security and developer tooling. These are the key features worth knowing.`,content:`
