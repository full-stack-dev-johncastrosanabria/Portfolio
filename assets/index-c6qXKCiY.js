...
Es una combinación muy útil para construir productos empresariales modernos sin perder orden técnico.
    `,tags:[`React`,`Full Stack`,`.NET`],publishedAt:`2026-03-10`,readingTime:`4 min`,source:`local`}];function J(e,t=`local`){if(`data`in e){let n=e.data();return{id:e.id,slug:n.slug,title:n.title,excerpt:n.excerpt,content:n.content,tags:n.tags??[],publishedAt:n.publishedAt??new Date().toISOString(),readingTime:n.readingTime??`4 min`,source:t}}return{...e,source:t}}function Y(){let[e,t]=(0,x.useState)(oe.map(e=>J(e))),[n,r]=(0,x.useState)(G),[i,a]=(0,x.useState)(``);return(0,x.useEffect)(()=>{async function e(){if(!G||!q){r(!1);return}try{let e=await _(p(ee(q,`posts`),h(`publishedAt`,`desc`)));e.empty||t(e.docs.map(e=>J(e,`firebase`)))}catch(e){console.warn(`No se pudieron cargar los posts desde Firebase. Se usarán los locales.`,e),a(`No se pudo conectar con Firebase. Se cargaron artículos locales.`)}finally{r(!1)}}e()},[]),{posts:(0,x.useMemo)(()=>[...e].sort((e,t)=>new Date(t.publishedAt).getTime()-new Date(e.publishedAt).getTime()),[e]),isLoading:n,error:i}}var se={en:{1:{title:`.NET 10: New features and performance improvements`,excerpt:`.NET 10 brings meaningful improvements in performance, security and developer tooling. These are the key features worth knowing.`,content:`
